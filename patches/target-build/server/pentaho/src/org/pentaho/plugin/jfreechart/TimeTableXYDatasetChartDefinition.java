...
public class TimeTableXYDatasetChartDefinition extends TimeTableXYDataset implements XYChartDefinition {
  ...
  private String tooltipXFormat = "d-MMM-yyyy HH:mm"; //$NON-NLS-1$
  ...
  public TimeTableXYDatasetChartDefinition(int chartType, IPentahoResultSet data, boolean byRow, Node chartAttributes,
  ...
  public TimeTableXYDatasetChartDefinition(IPentahoResultSet data, boolean byRow, Node chartAttributes,
      IPentahoSession session) {
