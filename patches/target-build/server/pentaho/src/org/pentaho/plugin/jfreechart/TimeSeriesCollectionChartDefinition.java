...
public class TimeSeriesCollectionChartDefinition extends TimeSeriesCollection implements XYChartDefinition {
    ...
    public TimeSeriesCollectionChartDefinition(int chartType, IPentahoResultSet data, boolean byRow,
        Node chartAttributes, IPentahoSession session) {
        this(session);
    ...
    public TimeSeriesCollectionChartDefinition(IPentahoResultSet data, boolean byRow, Node chartAttributes,
    ...
    private void setChartAttributes(Node chartAttributes) {
        ...
        setDateMinimum(chartAttributes.selectSingleNode(DATE_MINIMUM_NODE_NAME));

        // set the date minimum
        setDateMaximum(chartAttributes.selectSingleNode(DATE_MAXIMUM_NODE_NAME));
