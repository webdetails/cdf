...
(function() {
    ...
    var loadTimeline = function() {
        if (typeof Timeline != "undefined") {
            ...
            var timelineURL = (local) ? "/pentaho/cdf/js/simile/timeline/timeline-api.js?bundle=false" : "http://static.simile.mit.edu/timeline/api-2.0/timeline-api.js";
    ...
    if (typeof SimileAjax == "undefined") {
        ...
        var url = local ?
            "/pentaho/cdf/js/simile/ajax/simile-ajax-api.js?bundle=false" :
