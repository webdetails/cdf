...
define([
  ...
  return BaseComponent.extend(/** @lends cdf.components.UnmanagedComponent# */{
     ...
     *
     * @param {Error|*} arg An error object or the arguments of a {@link external:jQuery.ajax|jQuery.ajax} error
     *   callback.
     */
     ...
     *     }
     *
     * @param {cdf.components.UnmanagedComponent~executeCb} callback The executor function.
     */
     ...
     * @param {function}            callback     Callback to run after query has ran. It receives the fetched data as
     *                                           argument.
     ...
     * After the call to the <code>render callback</code>, the event {@link event:cdf.render|render} is fired, and then
     * execution ends.<br>
     ...
     * If passed, the supplied _ajaxParameters_ will be passed to the default ajax call.<br>
     *
