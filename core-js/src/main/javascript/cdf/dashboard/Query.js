...
define(['amd!../lib/underscore', '../lib/jquery'], function(_, $) {
   ...
   * @param {string} cd           Path to the server-side query or a chart definition object.
   * @param {string} dataAccessId The data access identifier.
   * @param {Object} dashboard    Dashboard where this query will be executed.
   * @return {Object} A new query object generated by calling {@link cdf.dashboard.Dashboard#getQuery|getQuery}.
