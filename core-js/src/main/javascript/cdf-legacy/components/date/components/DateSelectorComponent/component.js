...
window.wd.dateRangeSelectorModules  = window.wd.dateRangeSelectorModules || {};
   ...
   *
   **********************************************************************************************************************/
  window.wd.dateRangeSelectorModules.DateSelectorComponentDefaults = ( function ( BaseModel ){
    'use strict';
  ...
  window.wd.dateRangeSelectorModules.DateSelectorComponent = ( function ( _ , $ , moment ,  UnmanagedComponent , Logger , CustomDateBlock , DateSelectorComponentDefaults  ){
    'use strict';
  ...
  })( window._ , window.$ , window.moment , window.UnmanagedComponent , window.Logger , window.wd.dateRangeSelectorModules.CustomDateBlock , window.wd.dateRangeSelectorModules.DateSelectorComponentDefaults );

window.DateSelectorComponent = window.wd.dateRangeSelectorModules.DateSelectorComponent;
