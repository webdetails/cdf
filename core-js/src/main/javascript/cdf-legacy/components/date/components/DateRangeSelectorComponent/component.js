...
window.wd.dateRangeSelectorModules  = window.wd.dateRangeSelectorModules || {};
   ...
   *
   **********************************************************************************************************************/
  window.wd.dateRangeSelectorModules.DateRangeSelectorComponentDefaults = ( function ( BaseModel ){
    'use strict';
...
window.wd.dateRangeSelectorModules.DateRangeSelectorComponent = ( function ( _ , $ , moment ,  UnmanagedComponent , Logger , DateRangeSelectorBlock , DateRangeSelectorComponentDefaults  ){
  'use strict';
...
})( window._ , window.$ , window.moment , window.UnmanagedComponent , window.Logger , window.wd.dateRangeSelectorModules.DateRangeSelectorBlock , window.wd.dateRangeSelectorModules.DateRangeSelectorComponentDefaults );

window.DateRangeSelectorComponent = window.wd.dateRangeSelectorModules.DateRangeSelectorComponent;
