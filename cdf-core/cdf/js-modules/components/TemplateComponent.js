            ...
            try {
              switch(templateType.toUpperCase()) {
                case 'UNDERSCORE':
                  ...
                  html = _.template((_.isFunction(template) ? template() : template), model);
                  break;
                case 'MUSTACHE':
                  Mustache.Formatters = helpers;
                  html = Mustache.render((_.isFunction(template) ? template() : template), model);
                  break;
                default:
