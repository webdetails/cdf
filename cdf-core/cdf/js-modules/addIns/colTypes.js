...
define(['../AddIn', 'cdf/lib/datatables', '../dashboard/Dashboard', '../Logger', 'cdf/lib/underscore'], function (AddIn, DataTables, Dashboards, Logger, _) {
  ...
  Dashboards.registerGlobalAddIn("Table", "colType", new AddIn(sparkline));
  ...
  Dashboards.registerGlobalAddIn("Table", "colType", new AddIn(pvSparkline));
  ...
  Dashboards.registerGlobalAddIn("Table", "colType", new AddIn(dataBar));
  ...
  Dashboards.registerGlobalAddIn("Table", "colType", new AddIn(trendArrow));
  ...
  Dashboards.registerGlobalAddIn("Table", "colType", new AddIn(link));
  ...
  Dashboards.registerGlobalAddIn("Table", "colType", new AddIn(circle));
  ...
  Dashboards.registerGlobalAddIn("Table", "colType", new AddIn(bullet));
 ...
 var formattedText = {
  ...
  Dashboards.registerGlobalAddIn("Table", "colType", new AddIn(formattedText));
  ...
  Dashboards.registerGlobalAddIn("Table", "colType", new AddIn(localizedText));
  ...
  Dashboards.registerGlobalAddIn("Table", "colType", new AddIn(groupHeaders));
  ...
  Dashboards.registerGlobalAddIn("Table", "colType", new AddIn(clippedText));
