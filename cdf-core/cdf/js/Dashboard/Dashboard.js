  ...
  constructor: function(){
    ...
    function callIfAvailable(func){
      if(typeof func == "function"){
        ...
        console.log("calling init method of unloaded module");
      }
    }
    ...
    function configurePlugins() {
      ...
      if(typeof jQuery == 'function') {
        ...
        if(typeof jQuery.SetImpromptuDefaults == 'function') {
          ...
          console.log("jQuery.SetImpromptuDefaults plugin not loaded!!!!!!!!");
        }
        ...
        if(typeof jQuery.blockUI == 'function') {
          ...
          console.log("jQuery.blockUI plugin not loaded!!!!!!!!");
        }
      } else {
        console.log("jQuery plugin not loaded!!!!!!!!");
      }
    }
  },
