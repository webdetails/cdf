...
define(["cdf/Dashboard", "cdf/lib/jquery", "cdf/lib/underscore", "cdf/components/SelectBaseComponent", "cdf/components/CommentsComponent", 'cdf/dashboard/Query'], function(Dashboard, $, _, SelectBaseComponent, CommentsComponent, Query) {
    ...
    describe("The Select Component #", function() {
      ...
      it("Allows overriding AJAX settings", function() {
        ...
        var query = new Query({dataAccessId: "foo", path:"bar"}, null, myDashboard);
      ...
      describe("The externalPlugin #", function () {
        ...
        var mockDraw = function (plugin) {
          ...
          it("Behaves correctly, " + plugin, function (done) {
            ...
            spyOn(myDashboard, "processChange").and.returnValue(true);
        ...
        var hyndsSelect = makeSelect("mySelect", "hynds", myDashboard);
