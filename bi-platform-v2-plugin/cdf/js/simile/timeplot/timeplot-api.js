...
(function() {
    ...
    var loadTimeplot = function() {
        ...
        var timeplotURLPrefix = (local) ? WEB_CONTEXT_BASE + "content/pentaho-cdf/js/simile/timeplot/" : Timeplot.urlPrefix;
    ...
    var loadTimeline = function() {
        if (typeof Timeline != "undefined") {
            ...
            var timelineURL = (local) ? WEB_CONTEXT_BASE + "content/pentaho-cdf/js/simile/timeline/timeline-api.js?bundle=false" : "http://static.simile.mit.edu/timeline/api-2.0/timeline-api.js";
    ...
    if (typeof SimileAjax == "undefined") {
        ...
        var url = local ?
            WEB_CONTEXT_BASE + "content/pentaho-cdf/js/simile/ajax/simile-ajax-api.js?bundle=false" :
