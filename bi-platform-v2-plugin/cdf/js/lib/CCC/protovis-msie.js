      ...
      */
            ...
            init: function() {
                ...
                if (!vml.styles) {
                    ...
                    try {
                        if (!document.namespaces.pvml) {
                            document.namespaces.add('pvml', 'urn:schemas-microsoft-com:vml');
                        }
                    } catch (e) {
                        vml.pre = '<';
            ...
            rewritePath: function(p /*, deb */ ) {
              ...
              sweep = round(args[4]);*/
                        ...
                        case "l": // lineTo (relative)
                            op = 'l';
                            args = [(x = x + round(args[0])), (y = y + round(args[1]))];
                            break;
                        ...
                        case "C": // curveto (absolute)
                            ...
                            lastcurve = args = [
                                ...
                                round(args[2]), round(args[3]), (x = round(args[4])), (y = round(args[5]))
                            ];
                            break;
                        ...
                        case "c": // curveto (relative)
                            ...
                            lastcurve = args = [
                                ...
                                y + round(args[1]),
                                x + round(args[2]),
                                y + round(args[3]), (x = x + round(args[4])), (y = y + round(args[5]))
                            ];
                            break;
                        ...
                        case "S": // shorthand/smooth curveto (absolute)
                            ...
                            lastcurve = args = [
                                ...
                                round(args[0]),
                                round(args[1]), (x = round(args[2])), (y = round(args[3]))
                            ];
                            break;
                        ...
                        case "s": // shorthand/smooth curveto (relative)
                            ...
                            lastcurve = args = [
                                ...
                                lastcurve[5] + (lastcurve[5] - lastcurve[3]),
                                x + round(args[0]),
                                y + round(args[1]), (x = x + round(args[2])), (y = y + round(args[3]))
                            ];
                            break;
                        ...
                        case "Q": // quadratic Bezier curveto (absolute)
                            ...
                            var x1 = round(args[0]),
                                ...
                                x2 = round(args[2]),
                                y2 = round(args[3]);
                            args = [~~(x + (x1 - x) * 2 / 3), ~~ (y + (y1 - y) * 2 / 3), ~~ (x1 + (x2 - x1) / 3), ~~ (y1 + (y2 - y1) / 3), (x = x2), (y = y2)];
                            break;
                ...
                if (!scenes.parent) {
                    ...
                    if (!g) {
                        ...
                        for (var j = 0, E = events.length; j < E; j++) {
                            g.addEventListener ? g.addEventListener(events[j], dispatch, false) : g.attachEvent("on" + events[j], dispatch);
                        }
        ...
        pv.VmlScene.label = function(scenes) {
            ...
            for (var i = 0, L = scenes.length; i < L; i++) {
                ...
                switch (s.textBaseline) {
                    case 'middle':
                        dy = (.1 * label.height);
                        break; // slight middle baseline correction
                    case 'top':
        ...
        pv.VmlScene.wedge = function(scenes) {
            ...
            for (var i = 0, L = scenes.length; i < L; i++) {
                ...
                if (s.angle >= 2 * Math.PI) {
                    if (r1) {
                        d = "AE0,0 " + r2 + "," + r2 + " 0 23592960" + "AL0,0 " + r1 + "," + r1 + " 0 23592960";
                    } else {
                    ...
                    if (r1) {
                        d = "AE 0,0 " + r2 + "," + r2 + " " + -sa + " " + -a + " 0,0 " + r1 + "," + r1 + " " + -(sa + a) + " " + a + "X";
                    } else {
                        d = "M0,0" + "AE0,0 " + r2 + "," + r2 + " " + -sa + " " + -a + "X";
                    }
                }
                p.v = d;
