        ...
        for (var e = scene.$g.firstChild, round = vml.round, i = 0, L = scene.length; L > i; i++) {
            ...
            if (s.visible) {
                ...
                if (fill.opacity || stroke.opacity) {
                    ...
                    if (s.angle >= 2 * Math.PI) d = r1 ? "AE0,0 " + r2 + "," + r2 + " 0 23592960" + "AL0,0 " + r1 + "," + r1 + " 0 23592960" : "AE0,0 " + r2 + "," + r2 + " 0 23592960"; else {
                        var sa = Math.round(11796480 * (s.startAngle / Math.PI)), a = Math.round(11796480 * (s.angle / Math.PI));
